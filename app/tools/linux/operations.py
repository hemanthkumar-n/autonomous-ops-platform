...
def collect_disk(
    ...
    specs = [
        ...
        _spec(
            "block_devices",
            "Block-device topology, filesystem, and read-only state",
            "lsblk",
            "-e7",
            "-o",
            "NAME,KNAME,TYPE,SIZE,FSTYPE,MOUNTPOINTS,PKNAME,MODEL,SERIAL,ROTA,RO,STATE",
        ),
        _spec(
            "lvm_pvs",
            "LVM physical-volume state",
            "pvs",
            "--noheadings",
            "-o",
        ...
        _spec(
            "lvm_lvs",
            "LVM logical-volume state",
            "lvs",
            "--noheadings",
            "-o",
            "lv_name,vg_name,lv_size,origin,pool_lv,data_percent,metadata_percent,lv_attr",
        ),
        _spec(
            "multipath",
            "Multipath device and path state",
            "multipath",
            "-ll",
            requires_root=True,
        ),
        _spec(
            "nfs_mountstats",
            "NFS mount statistics and RPC state",
            "cat",
            "/proc/self/mountstats",
        ),
        _spec(
            "io_stats",
            "Block-device latency and utilization sample",
            "iostat",
            "-xz",
            "1",
            "2",
